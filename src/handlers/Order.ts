...
/**
 * @dev ERC20 transfer should have an extra data we use to identify a hyper limit.
 * A transfer with a hyper limit looks like:
 *
 * 0xa9059cbb
 ...
 *
 * The important part is 2070696e652e66696e616e6365 which is the hexa of ` plasma.finance` used for the secret.
...
export function handleOrderCancelled(event: OrderCancelled): void {
  ...
  let hyperLimit = HyperLimit.bind(event.address)
  let res = hyperLimit.try_existOrder(
